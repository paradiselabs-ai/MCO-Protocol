...
class SimpleAgent:
    ...
    def execute_direct(self, task: str, model: str = "claude-3-5-sonnet") -> Dict[str, Any]:
    ...
    def execute_with_mco(self, task: str, mco_context: Dict[str, Any], model: str = "claude-3-5-sonnet") -> Dict[str, Any]:
